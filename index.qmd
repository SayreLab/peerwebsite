...
[![](images/sayrelab.png)](https://handbook.zaposa.com){fig-alt="Eleanor Sayre" width="100%"}
...
:::{.g-col-1 .card .card-body .text-center}
[![](images/peer.png)](model/index.qmd){fig-alt="Eleanor Sayre" width="100%"}
...
:::{.g-col-1 .card .card-body .text-center}
[![](images/pants.png)](schools/index.qmd){fig-alt="Eleanor Sayre" width="100%"}
...
Additionally, we can give colloquium-style talks to broader audiences at your institution. Want something else? Contact Eleanor Sayre for more ideas, or join the [announcements list](contact.qmd) to hear about new opportunities.
