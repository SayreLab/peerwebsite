...
:::{.badge .rounded-pill .bg-info .text-center}
[More Information](contact.qmd)
:::
...
```
:::{.badge .rounded-pill .bg-info .text-center}
[More Information](contact.qmd){.quarto-grid-link}
:::
...
lorem::ipsum()
```
:::{.btn .btn-primary .btn-sm .rounded-pill .text-center}
More Information
:::
