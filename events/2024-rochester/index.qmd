...
Field school dates<br> August 1-7, 2024
:::
...
[APPLY NOW](https://rit.az1.qualtrics.com/jfe/form/SV_eyXtv1XEexuMm58){.btn .btn-primary .rounded-pill role="button"}
...
::: {.g-col-1 .text-left}
![Erin Scott-Stewart](../../images/headshots/Scott-Stewart-headshot.jpg){fig-alt="Erin Scott-Stewart" width="100%"}
:::

::: {.g-col-1 .text-left}
![Christian Solorio](../../images/headshots/Solorio-headshot.jpg){fig-alt="Christian Solorio" width="100%"}
...
::: g-col-1
![](../../images/foreign-logos/NSF-logo.png){.center fig-alt="National Science Foundation logo" width="100%"}
:::

::: g-col-1
[![](../../images/foreign-logos/RIT.jpg){.center fig-alt="RIT logo" width="100%"}](https://www.rit.edu/castle/)
:::
