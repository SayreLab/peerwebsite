...
:::{.alert .alert-info }
###  PEER Convening {.alert-heading}

The PEER Convening will be November 21, 2-4 EST over zoom.  All previous PEER participants are welcome!  [More information and registration link](convening-meeting/index.qmd){.alert-link}
