...
::: {.column-screen style="padding-left:10px;padding-top:10px;"}
...
:::{.column-screen .bg-info-light style="padding-left:10px;"}
...
![PEER was really impactful for me and gave me a kick start to begin the process which seemed overwhelming.  It gave me confidence and experience thinking about educational research. I came up with an entirely new project and ran with it. I was able to come up with a better research question, get IRB approval, and draft a conference paper (submitted last week!).](../images/action-shots/action1.png){.rounded .font-weight-bold}
...
::: {.column-screen style="padding-left:10px;"}
