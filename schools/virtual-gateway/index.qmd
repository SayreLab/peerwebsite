...
:::{apply-now-button}
```{=HTML}
<a class="btn btn-primary rounded-pill text-center" data-margin-top="0" data-margin-bottom="0" href="https://peerinstitute.org/contact/">
    <p>REGISTRATION IS CLOSED. SIGN UP FOR THE MAILING LIST?</p>
</a>
```
:::
::::
