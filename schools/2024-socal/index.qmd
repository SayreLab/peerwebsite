...
title: "PEER-SoCal (Summer, 2024)"
description: "Regional Field School for Emerging Discipline-based Researchers (EDBERs) at the University of San Diego, July 22-25, 2024."
...
Date | Activity
---|-------
TBD, early July | Virtual Kickoff 
Monday, July 22, 1:00-6:00pm | Opening session, Research design, communication and ethics with optional group dinner outing afterward
Tuesday, July 23: 9:00am-4:00pm | Data and Access, IRB, Ethics and Doing Interviews
Wednesday, July 24: 9:00am-4:00pm | Theories, Iterative Design and Generative Presentations
...
::::{.g-col-1 .text-left}
![Stanley Lo](../../images/headshots/Lo-headshot.jpg){fig-alt="Stanley Lo" width="100%"}
::::
...
::::{.g-col-1}
![](../../images/foreign-logos/usd-logo-medallion-thumb.png){fig-alt="University of San Diego logo" width="100%" .center}
...
:::::::{.g-col-1 .text-left}
This PEER field school is partially supported by the National Science Foundation [BCSER program](https://www.nsf.gov/awardsearch/showAward?AWD_ID=2025174&HistoricalAwards=false) (DRL-2025169).
:::::::
::::::::
:::::::::