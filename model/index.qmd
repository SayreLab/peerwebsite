...
:::{.column-page  layout="[2,5,2]" style="padding-bottom:20px"}
...
::: {.column-page .quarto-listing .quarto-listing-container-grid }
...
:::{.column-page .bg-info style="padding:10px;"}
...
Our collaborators and hosts at the University of Cologne made a promotional video for their [PEER field school](/events/2024-koln).
...
::: {.g-col-1 .text-center style="margin-left:40px;margin-right:40px;background-image:url(chatty-group-1.png);background-repeat:no-repeat;background-size: cover;position: relative;"}
...
<!-- Image loader, keep this -->
![](facilitator_explaining.png){.d-none}
![](chatty-group-1.png){.d-none}
