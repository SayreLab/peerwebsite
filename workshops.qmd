...
Fabulous! Check out [hosting opportunities](model/localhost.qmd) to learn about how.
:::

:::{.g-col-1 .text-center}
# I want to join a field school.

Exciting! Check out [upcoming field schools](schools/index.qmd) to see if there's one near you.
:::
::::
:::::